                ...
                <div className="max-w-3xl text-center text-white">
                    <div className="lg:col-span-7 text-center lg:text-left space-y-6">
                        ...
                        <div className="py-8 border-t border-gray-50/30 grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0 text-center lg:text-left">
                            ...
                            <div className="text-center py-3 px-3 bg-amber-500/[0.03] backdrop-blur-sm border border-amber-500/20 rounded-2xl shadow-[0_0_15px_rgba(245,158,11,0.05)]">
                                <h4 className="flex justify-center items-center gap-1 text-2xl font-black text-amber-400">
                                    4.9
                                    <span className="text-amber-400 -mt-1 filter drop-shadow-[0_0_8px_rgba(245,158,11,0.5)]">
                                        <FaStar size={16} />
                                    </span>
                                </h4>
                            ...
                            <div className="text-center py-3 px-3 bg-emerald-500/[0.03] backdrop-blur-sm border border-emerald-500/20 rounded-2xl shadow-[0_0_15px_rgba(16,185,129,0.05)]">
                                ...
                                <p className="text-[11px] font-medium text-slate-300 mt-1">Expert Doctors</p>
                            </div>

                            <div className="text-center py-3 px-3 bg-sky-500/[0.03] backdrop-blur-sm border border-sky-500/20 rounded-2xl shadow-[0_0_15px_rgba(14,165,233,0.05)]">

...
const DoctorDetailHeroSection = () => {
  return (
    <section className="relative overflow-hidden border px-5 md:px-10 py-16 ">
      {/* Background Image */}
      <div
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        {/* Badge */}
        <span className="inline-flex items-center gap-2 px-5 py-1 rounded-full bg-white/80 backdrop-blur-xl border border-sky-100 shadow-md text-sky-700 text-sm font-semibold">
          <FaHeart /> Trusted Medical Care For You
        </span>
        ...
        <p className="mt-2 text-gray-300 text-base leading-relaxed">
          View detailed doctor information, consultation schedules, patient
          ratings, and clinic details to make informed healthcare decisions.
        </p>
